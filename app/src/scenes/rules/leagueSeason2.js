...
const League = () => (
  <div className="prose prose-lg mx-auto p-5">
    <h1 className="text-3xl font-bold mb-4">INCOMING SEASON</h1>
    <p>
    ...
    <p className="text-2xl font-bold mt-6 mb-2 text-red-600">
      This is the list of official clients to use:
    </p>
    ...
    <p className="font-bold text-red-600 mt-6 mb-2">
      ...
      <p className="text-red-600">
        If you use the macOS client, then execute this command in the Terminal
        app, once the client is installed : <br />
      ...
      <br />
      <p className="text-red-600">
        If you use the Linux client, then you might be missing dependencies.
        Install them with these commands in the terminal : <br />
        <p className="bg-gray-200 p-2 rounded-md text-gray-800 font-mono font-normal">
          # Debian/Ubuntu
          <br />
          sudo apt install libavcodec-extra libavdevice-dev libavfilter-dev
          libavformat-dev libavutil-dev libcurl4-openssl-dev libfreetype6-dev
          libglew-dev libsdl2-dev libvulkan-dev
          <br />
          <br />
          # CentOS, RedHat and AlmaLinux
          <br />
          sudo yum install libcurl-devel ffmpeg-devel freetype-devel glew-devel
          SDL2-devel vulkan-devel
          <br />
          <br />
          # Fedora
          <br />
          sudo dnf install libcurl-devel ffmpeg-devel freetype-devel glew-devel
          SDL2-devel vulkan-devel
          <br />
          <br />
          # Arch Linux
          <br />
          sudo pacman -S --needed curl ffmpeg freetype2 glew sdl2
          vulkan-icd-loader
          <br />
        </p>
        <br />
    ...
    <p className="font-bold text-red-600 mt-6 mb-2">
      <p className="font-bold text-2xl">Attention</p>
      <p className="text-red-600">
        If you use the macOS client, then execute this command, once the client
        is installed : <br />
        <p className="bg-gray-200 p-2 rounded-md text-gray-800 font-mono font-normal">
      ...
      <p className="text-red-600">
        If you use the Linux client, then you might be missing dependencies.
        Install them with these commands : <br />
        <p className="bg-gray-200 p-2 rounded-md text-gray-800 font-mono font-normal">
          # Debian/Ubuntu
          <br />
